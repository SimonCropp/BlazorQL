...
<img src="../src/BlazorQL.Sample.Tests/UiScreenshotTests.Home.verified.png" border="1" alt="The sidecar open beside an ordinary app page, showing the query the page ran on load">
